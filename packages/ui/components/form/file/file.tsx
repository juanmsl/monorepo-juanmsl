import { FileCardSC, FileSC } from './file.style';
import { Icon, IconNameT } from '../../../contexts';
import { FileResolvedT, FileTypeEnum, useFileReader, useUtilities } from '@juanmsl/hooks';
import { withController } from '../with-controller';
import { InputProps, InputFileProps } from '../types';
