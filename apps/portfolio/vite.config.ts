  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        description:
          'I am a software engineer who loves code, with a strong passion for design. Currently I specialize on web development creating amazing and professional websites, taking care for the user experience and applying good practices on code for a strong quality and scalability.',
        scope: '/',
        id: '/',
        start_url: '/',
        ...
        shortcuts: [
          {
            ...
            short_name: 'Resume',
            description:
              'Do you want to get started with your project and you need my help, or you just want to work with me? Please contact me.',
            url: '/resume',
            icons: [{ src: 'manifest/icons/icon-192.png', sizes: '192x192', type: 'image/png' }],
          },
        ],
      },
    }),
